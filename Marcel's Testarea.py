...
#löscht unnötiges züg us de lischte
...
#da sind variable ahgäh für segmentchnopf und numpad (was grad drückt wird)
segmentbutton = 1
numpadinput = 15


#input, da chunnt denn segmentchnopf-input und numpad-input ine 
if final_list[segmentbutton] == "0":
    if numpadinput != 0:
        final_list[segmentbutton] = numpadinput
        numpadinput = 0
